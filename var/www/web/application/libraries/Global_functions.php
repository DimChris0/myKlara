...
class Global_functions 
{
    ...
    public function jobs_add ($yara_rules, $yara_fileset_scan, $job_type, $return_jobs_ids = false)
    {
        ...
        $final_repositories[] = $yara_fileset_scan;
        ...
        foreach ($final_repositories as $repo_id)
        {
            ...
            if ($q->num_rows() == 1)
            {
                ...
                $returned_ids = $this->jobs_add_db ($initial_repo_scan_fileset, $user_notify_email, $yara_rules, $job_type);
    ...
    public function jobs_add_db ($initial_repo_scan_fileset, $user_notify_email, $yara_rules, $job_type)
    {
        $jobs_ids = array();
        ...
        foreach ($all_scan_filesets as $repository_scan_path)
        {
	       ...
	       $db_insert['job_type']       = intval($job_type);
