$(document).ready(function() 
{
    ...
    $( "#form_add_job_submit" ).on( "click", function( event ) 
    {
        ...
        var scan_path = $('input[type="text"]','#form_add').map(function(){return this.value;}).get();
	var operation_option = $('input[name="operation_opt"]:checked','#form_add').val();

	//var operation_option = "do_ls";
        // Get the yara_rules
        var yara_rules = ace.edit("yara_rules").getValue();
        var post_obj =  {
            yara_rules: yara_rules,
	    operation_option: operation_option,
            "yara_fileset_scan": scan_path,
        };
